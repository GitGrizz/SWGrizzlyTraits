...
public class ModWeaponTraitTagsProvider extends ForgeRegistryTagsProvider<WeaponTrait> 
{
	...
	protected void addTags() 
	{
		...
		tag(ModWeaponTraitTags.LONGSWORD).add(WeaponTraits.TWO_HANDED_1.get(), WeaponTraits.BLOCK_MELEE.get());
		tag(ModWeaponTraitTags.KATANA).add(WeaponTraits.TWO_HANDED_1.get(), WeaponTraits.BLOCK_MELEE.get(), WeaponTraits.DAMAGE_BONUS_CHEST.get(), WeaponTraits.SWEEP_1.get());
		...
		tag(ModWeaponTraitTags.GREATSWORD).add(WeaponTraits.TWO_HANDED_2.get(), WeaponTraits.BLOCK_MELEE.get(), WeaponTraits.REACH_1.get(), WeaponTraits.SWEEP_3.get());
		tag(ModWeaponTraitTags.CLUB).add(WeaponTraits.NAUSEA.get());
		tag(ModWeaponTraitTags.CESTUS).add(WeaponTraits.QUICK_STRIKE.get());
		tag(ModWeaponTraitTags.BATTLE_HAMMER).add(WeaponTraits.KNOCKBACK.get(), WeaponTraits.NAUSEA.get(), WeaponTraits.ARMOUR_PIERCING.get(), WeaponTraits.HAMMER_SLAM.get());
		tag(ModWeaponTraitTags.WARHAMMER).add(WeaponTraits.TWO_HANDED_1.get(), WeaponTraits.BLOCK_MELEE.get(), WeaponTraits.ARMOUR_PIERCING.get());
		tag(ModWeaponTraitTags.SPEAR).add(WeaponTraits.REACH_1.get());
		tag(ModWeaponTraitTags.HALBERD).add(WeaponTraits.TWO_HANDED_2.get(), WeaponTraits.BLOCK_MELEE.get(), WeaponTraits.REACH_1.get(), WeaponTraits.SHIELD_BREACH.get());
		tag(ModWeaponTraitTags.PIKE).add(WeaponTraits.TWO_HANDED_1.get(), WeaponTraits.BLOCK_MELEE.get(), WeaponTraits.REACH_2.get());
		...
		tag(ModWeaponTraitTags.BATTLEAXE).add(WeaponTraits.TWO_HANDED_1.get(), WeaponTraits.BLOCK_MELEE.get(), WeaponTraits.VERSATILE_AXE.get());
		tag(ModWeaponTraitTags.FLANGED_MACE).add(WeaponTraits.DAMAGE_BONUS_UNDEAD.get(), WeaponTraits.ARMOUR_PIERCING.get());
		tag(ModWeaponTraitTags.GLAIVE).add(WeaponTraits.TWO_HANDED_1.get(), WeaponTraits.REACH_1.get(), WeaponTraits.SWEEP_2.get());
		tag(ModWeaponTraitTags.QUARTERSTAFF).add(WeaponTraits.TWO_HANDED_1.get(), WeaponTraits.BLOCK_MELEE.get(), WeaponTraits.SWEEP_2.get());
